...
public class PilotController {
    ...
    private PilotModel pilotView(@PathVariable(value = "licenseNumber") String licenseNumber) {
        PilotModel pilot = pilotService.getPilotDetailByLicenseNumber(licenseNumber).get();
        return pilot;
    }

    @DeleteMapping(value = "/delete")
    private String deletePilot(@RequestParam(value = "pilotId") long pilotId) {
    ...
    private String updatePilotSubmit(@PathVariable(value = "pilotId") long pilotId,
